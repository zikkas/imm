...
\begin{align*}
	\sum_{n=1}^{N} \frac{1}{n}
	&= \int_{1}^{N} \frac{1}{x} dx + \frac{1/N + 1}{2} + \int_{1}^{N} \frac{B_1(\{x\})}{1!} \left(\frac{-1}{x^2}\right) dx \\
	&= \log N + \frac{N+1}{2N} - \int_{1}^{N} \frac{\{x\}}{x^2} dx + \int_{1}^{N} \frac{1}{x^2} dx \\
	&= \log N + \frac{N+1}{2N} + \frac{N-1}{2N} - \int_{1}^{N} \frac{\{x\}}{x^2} dx \\
	&= \log N + 1 - \underbrace{\int_{1}^{\infty} \frac{\{x\}}{x^2} dx}_{I_1} + \underbrace{\int_{N}^{\infty} \frac{\{x\}}{x^2} dx}_{I_2}
\end{align*}
Now we need to show that $I_1 \, \text{and } I_2$ are convergent. For this we use the fact that $\dfrac{\{x\}}{x^2} \le \dfrac{1}{x^2}\, \text{in } [1, \infty)$. And so we get:
\begin{align*}
	I_1 &= \int_{1}^{\infty} \frac{\{x\}}{x^2} dx \\
	  &\le \int_{1}^{\infty} \frac{1}{x^2} dx \\
	  &= 1
\end{align*}
Which mean that $I_1$ is convergent and is a constant, call it $c$.


For $I_2$, we have:
\begin{align*}
	I_2 &= \int_{N}^{\infty} \frac{\{x\}}{x^2} dx \\
	    &\le \int_{N}^{\infty} \frac{1}{x^2} dx \\
	    &= \frac{1}{N}
\end{align*}
...
$$
\sum_{n=1}^{N} \frac{1}{n} = \log N + \underbrace{\gamma}_{1 - c} + O\left(\frac{1}{N}\right)
$$
